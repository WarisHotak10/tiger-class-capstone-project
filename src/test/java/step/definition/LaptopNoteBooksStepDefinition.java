...
public class LaptopNoteBooksStepDefinition extends Base {
	...
	public void user_click_on_laptop_note_book_tab() {
		laptopnotebooksPageObject.clickOnLaptopsAndNotebooksLink();
		logger.info("User successfully clicked on laptops & notebooks tab");
		Utils.hardWait(2000);
	}
	...
	public void user_click_on_show_all_laptop_note_book_option() {
		...
		logger.info("User successfully clicked on show all laptop & notebooks option");
		Utils.hardWait(2000);
	}
...
//	}
	...
	public void user_should_see_tem_s_showed_to_the_cart(Integer int1, Double double1) {
		laptopnotebooksPageObject.isOneItemShowedToTheCart();
		logger.info("User see One Item in the cart successfully");
		Utils.hardWait(2000);
	}
	...
	public void user_click_on_red_x_button_to_remove_the_item_from_cart() {
		...
		logger.info("User successfully clicked on red X button to remove the item from cart");
		Utils.hardWait(2000);
	}
	...
	public void item_should_be_removed_and_cart_should_show_item_s(Integer int1) {
		laptopnotebooksPageObject.isZeroItemInTheCart();
		logger.info("User successfully removed Item from cart");
		Utils.hardWait(2000);
	}
...
//  Scenario 3
	...
	public void user_should_get_a_message(String expected) {
		...
		logger.info(
				"User get the message: You must login or create an account to save Sony VAIO to your wish list! successfully");
		Utils.takeScreenshotForStep();
		Utils.hardWait(1000);
	}
